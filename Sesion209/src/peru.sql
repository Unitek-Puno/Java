-- --------------------------------------------------------
-- Host:                         127.0.0.1
-- Versión del servidor:         5.5.39-0ubuntu4 - (Ubuntu)
...
-- Volcando estructura de base de datos para peru
CREATE DATABASE IF NOT EXISTS `peru` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `peru`;


-- Volcando estructura para tabla peru.ubdepartamento
...
-- Volcando datos para la tabla peru.ubdepartamento: 25 rows
...
-- Volcando estructura para tabla peru.ubdistrito
...
-- Volcando datos para la tabla peru.ubdistrito: 1.831 rows
...
-- Volcando estructura para tabla peru.ubprovincia
...
-- Volcando datos para la tabla peru.ubprovincia: 193 rows
